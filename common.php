<?php 
require_once DISCUZ_ROOT . DIRECTORY_SEPARATOR . 'source' . DIRECTORY_SEPARATOR . 'class' . DIRECTORY_SEPARATOR . 'class_core.php';

require_once DISCUZ_ROOT . DIRECTORY_SEPARATOR . 'source' . DIRECTORY_SEPARATOR . 'function' . DIRECTORY_SEPARATOR . 'function_core.php';
